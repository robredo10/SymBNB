    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('coverImage', UrlType::class, $this->getConfiguration(
                ...
                "Donnez l'adresse d'une image qui donne envie"
            ))
            ->add('introduction', TextType::class, $this->getConfiguration(
                "Introduction",
                "Donnez une description de votre annonce"
            ))
            ->add('content', TextareaType::class, $this->getConfiguration(
                "Description detaillée",
                "Donnez une description pour votre votre annonce en valeur"
            ))
            ->add('content', TextareaType::class, $this->getConfiguration(
                "Description detaillée",
                "Donnez une description pour votre votre annonce en valeur"
            ...
            ->add('price', MoneyType::class, $this->getConfiguration(
                "Prix par nuit",
                "Indiquez le prix pour une nuite"
            ))
            ->add(
                'images',
